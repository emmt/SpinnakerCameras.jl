...
const CAMERA_STATE_INITIALIZING = Cint(0)
const CAMERA_STATE_SLEEPING     = Cint(1)
const CAMERA_STATE_STARTING     = Cint(2)
const CAMERA_STATE_ACQUIRING    = Cint(3)
const CAMERA_STATE_STOPPING     = Cint(4)
const CAMERA_STATE_ABORTING     = Cint(5)
const CAMERA_STATE_FINISHED     = Cint(6)
